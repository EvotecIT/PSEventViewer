    ...
    public class TestBuildQueryString {
        ...
        public void ProviderNameEscapesSpecialCharacters() {
            var method = typeof(SearchEvents).GetMethods(BindingFlags.NonPublic | BindingFlags.Static)
                .First(m => m.Name == "BuildQueryString" && m.GetParameters().Length == 12);
            string result = Assert.IsType<string>(method.Invoke(null, new object?[]{"Log", null, "O'Reilly & Co", null, null, null, null, null, null, null, null, null}));
        ...
        public void LogNameIsXmlEscapedWithoutChangingTheEventLogPath() {
            ...
            string result = Assert.IsType<string>(method.Invoke(null, new object?[] { "Company & Product/Log", null, null, null, null, null, null, null, null, null, null, null }));
        ...
        public void InvalidUserIdentifierIsRejectedBeforeBuildingQuery() {
            ...
            var exception = Assert.Throws<TargetInvocationException>(() => method.Invoke(
                null,
                new object?[] { "Security", null, null, null, null, null, null, "not-a-valid-account-or-sid", null, null, null, null }));
        ...
        public void EventIdMultipleValuesOr() {
            var method = typeof(SearchEvents).GetMethods(BindingFlags.NonPublic | BindingFlags.Static)
                .First(m => m.Name == "BuildQueryString" && m.GetParameters().Length == 12);
            string result = (string)method.Invoke(null, new object?[]{"Log", new System.Collections.Generic.List<int>{1, 2}, null, null, null, null, null, null, null, null, null, null});
        ...
        public void LocalTimeIsConvertedToUtcBeforeAppendingZuluSuffix() {
            ...
            string result = (string)method.Invoke(null, new object?[] { "Log", null, null, null, null, localTime, null, null, null, null, null, null });
