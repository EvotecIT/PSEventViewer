...
/// <summary>
/// Typed named-event projection with common event metadata and the original event snapshot.
/// </summary>
public class NamedEventRecord {
    /// <summary>
    ...
    /// </summary>
    public string NamedEventName { get; protected set; } = string.Empty;
    ...
    public NamedEventRecord(EventObject eventObject) {
        ...
        SourceLogName = SourceEvent.ContainerLog;
    }
