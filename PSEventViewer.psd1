@{
    ...
    CmdletsToExport      = @('Find-WinEvent', 'Start-EventWatching', 'Write-WinEvent', 'Get-WinEventSettings')
    CompanyName          = 'Evotec'
    CompatiblePSEditions = @('Desktop', 'Core')
    Copyright            = '(c) 2011 - 2024 Przemyslaw Klys @ Evotec. All rights reserved.'
    Description          = 'Simple module allowing parsing of event logs. Has its own quirks...'
    FunctionsToExport    = @('Get-Events', 'Get-EventsFilter', 'Get-EventsInformation', 'Set-EventsSettings')
