@{
    ...
    CmdletsToExport      = @('Find-WinEvent', 'Get-WinEventFilter', 'Start-EventWatching', 'Write-WinEvent')
    CompanyName          = 'Evotec'
    CompatiblePSEditions = @('Desktop', 'Core')
    Copyright            = '(c) 2011 - 2024 Przemyslaw Klys @ Evotec. All rights reserved.'
    Description          = 'Simple module allowing parsing of event logs. Has its own quirks...'
    FunctionsToExport    = @('Get-Events', 'Get-EventsInformation', 'Get-EventsSettings', 'Set-EventsSettings')
