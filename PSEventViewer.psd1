@{
    ...
    CmdletsToExport      = @('Clear-EVXLog', 'Get-EVXEvent', 'Get-EVXEventStatistics', 'Get-EVXFilter', 'Get-EVXInfo', 'Get-EVXLog', 'Get-EVXPowerShellScript', 'Get-EVXProviderList', 'Get-EVXWatcher', 'New-EVXLog', 'Remove-EVXLog', 'Remove-EVXSource', 'Set-EVXInfo', 'Set-EVXLogLimit', 'Start-EVXWatcher', 'Stop-EVXWatcher', 'Write-EVXEntry')
    CompanyName          = 'Evotec'
